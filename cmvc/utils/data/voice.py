...
from cmvc.utils.property import define_property, define_properties
...
class SampledWave(object):
    ...
    def load_wav(self,
        ...
        ampl = librosa.effects.remix(ampl, intervals=librosa.effects.split(ampl, top_db=50))
        tmp = len(ampl)%4
        if tmp:
            ampl = ampl[:-tmp]
        return ampl, fs
...
class Features(object):
    ...
    def extract_mc(self,
        ...
        alpha = 0.46 # round(math.log(fs/1000)/2.9, 2)
